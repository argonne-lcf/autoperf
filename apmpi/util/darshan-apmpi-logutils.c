    ...
    char *mnt_pt, char *fs_type)
{
    ...
    { 
        ...
        hdr_rec = rec;
        DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
        ...
        DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec->base_rec.rank, hdr_rec->base_rec.id,
            "memory_mode", apmpi_mmodes[hdr_rec->memory_mode & ~(1<<31)], "", "", "");
        DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec->base_rec.rank, hdr_rec->base_rec.id,
            "memory_mode_consistent", ((hdr_rec->memory_mode & (1<<31)) == 0), "", "", "");
        DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec->base_rec.rank, hdr_rec->base_rec.id,
            "cluster_mode", apmpi_cmodes[hdr_rec->cluster_mode & ~(1<<31)], "", "", "");
        DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec->base_rec.rank, hdr_rec->base_rec.id,
    ...
    void *file_rec2, char *file_name2)
{
    ...
    if (hdr_rec1->magic == DARSHAN_APMPI_MAGIC)
    {
        ...
        if (!hdr_rec2)
        {
            ...
            DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec1->base_rec.rank, hdr_rec1->base_rec.id,
                "memory_mode", apmpi_mmodes[hdr_rec1->memory_mode & ~(1<<31)], "", "", "");
            printf("- ");
            DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec1->base_rec.rank, hdr_rec1->base_rec.id,
            ...
            DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec1->base_rec.rank, hdr_rec1->base_rec.id,
                "cluster_mode", apmpi_cmodes[hdr_rec1->cluster_mode & ~(1<<31)], "", "", "");
            DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec1->base_rec.rank, hdr_rec1->base_rec.id,
        ...
        else if (!hdr_rec1)
        {
            ...
            DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec2->base_rec.rank, hdr_rec2->base_rec.id,
                "memory_mode", apmpi_mmodes[hdr_rec2->memory_mode & ~(1<<31)], "", "", "");
            printf("+ ");
            DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
            hdr_rec2->base_rec.rank, hdr_rec2->base_rec.id,
            ...
            DARSHAN_S_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec2->base_rec.rank, hdr_rec2->base_rec.id,
                "cluster_mode", apmpi_cmodes[hdr_rec2->cluster_mode & ~(1<<31)], "", "", "");
            DARSHAN_I_COUNTER_PRINT(darshan_module_names[DARSHAN_APMPI_MOD],
                hdr_rec2->base_rec.rank, hdr_rec2->base_rec.id,
